  ...
  return (
    <main className="feedPage dockLayout" onTouchStart={beginSwipe} onTouchEnd={finishSwipe}>
      ...
      <nav className="bottomDock" aria-label="주요 화면">
        ...
        <button className={currentSection === "feed" ? "active" : ""} onClick={() => navigateSection("feed")} aria-label="피드"><span className="feedHashIcon"><Hash size={13} strokeWidth={1.55} /></span></button>
